...
def main(argv):
    ...
    na_trades = np.loadtxt(ordersFilename, dtype={'names': ('Year','Month','Day', 'Symbol', 'txType', 'nShares', 'priceType', 'stopLossFlag'),
                                                  'formats': ('i4', 'i4','i4', 'S5', 'S5','i4', 'S5', 'S5')}, delimiter=',')
    #print(na_trades)
    na_trades_norm = []
    ...
    for record in na_trades:
        ...
        na_trades_norm.append((aDate,record[3], record[4], record[5], record[6]));
    ...
    for dt_date in ldt_timestamps:
        ...
        while  dt_date == na_trades_norm[i][0]:
            ...
            priceType = na_trades_norm[i][4]
            price = d_data[priceType][symbol].ix[dt_date]
            print 'price of type ', priceType,' = ', price 
            if (txType == 'Buy'):
    ...
    for dt_date in ldt_timestamps:
        ...
        for symbol in d_current_positions.keys():
            ...
            if nSharesOfSymbol != 0:
                stockPrice = d_data[priceType][symbol].ix[dt_date]
